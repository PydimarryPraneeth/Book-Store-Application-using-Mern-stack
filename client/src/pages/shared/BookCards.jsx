          ...
          {books.map((book) => (
            ...
            >
              <Link to={`/book/${book._id}`} className="cursor-pointer">
                <div className="bg-gray-100 hover:bg-logcolor  p-8 rounded-lg relative">
                  <img src={book.imageURL} alt="" className="w-full" />
                  <div className="absolute top-3 right-3 bg-black hover:bg-logotextcolor p-2 rounded ">
                ...
                <div className="mt-5 mb-8 text-left space-y-2 flex justify-between items-start">
                  ...
                  <div>
                    <p className="font-bold text-logotextcolor">₹495.00</p>
                  </div>
                </div>
              </Link>
            </SwiperSlide>
