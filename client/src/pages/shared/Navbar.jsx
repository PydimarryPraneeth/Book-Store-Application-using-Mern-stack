      ...
      >
        <div className="flex justify-between items-center text-base gap-8">
          ...
          <div className="space-x-12 hidden lg:flex items-center ">
            ...
            {user ? (
              <Link to="/admin/dashboard" className="hover:text-logotextcolor font-belanosima text-lg font-semibold">
                {user.email}
              </Link>
            ) : (
              <Link to="/login" className="hover:text-logotextcolor font-belanosima text-lg font-semibold">
                {"LOGIN"}
              </Link>
            )}
          </div>
